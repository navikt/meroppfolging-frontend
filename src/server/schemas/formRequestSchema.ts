...
import {
  BEHOV_FOR_OPPFOLGING_ANSWER_TYPES,
  FREMTIDIG_SITUASJON_ANSWER_TYPES,
...
export const FormSchema = z.tuple([
  FremtidigSituasjonFormSchema,
  BehovForOppfolgingFormSchema,
]);
