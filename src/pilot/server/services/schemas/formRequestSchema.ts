...
import { BEHOV_FOR_OPPFOLGING_ANSWER_TYPES, FREMTIDIG_SITUASJON_ANSWER_TYPES } from '@/pilot/domain/answerValues'
import { QUESTION_TYPES } from '@/pilot/domain/formValues'
