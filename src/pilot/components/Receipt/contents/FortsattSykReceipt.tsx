...
import AccordionItem from "@navikt/ds-react/src/accordion/AccordionItem";
    ...
    return (
        <>
            ...
            <BodyLong>
                ...
                erstatter en del av inntektstapet ditt. Husk at du også kan ha rettigheter hos forsikringsselskapet
                eller
                pensjonskassen din.
            </BodyLong>
            <BodyLong>
...
export function FortsattSykAccordianItem(): ReactElement {
    return <AccordionItem><FortsattContent/>< /AccordionItem>
}

function FortsattSykReceipt(): ReactElement {
    return <FortsattSykContent/>
}
