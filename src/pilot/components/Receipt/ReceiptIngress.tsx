...
function Content({ formResponse }: { formResponse: Form }): ReactElement {
  const behovForOppfolgingAnswer = formResponse[1].answerType
...
function ReceiptIngress({ formResponse }: { formResponse: Form }): ReactElement {
  return <Content formResponse={formResponse} />
}
