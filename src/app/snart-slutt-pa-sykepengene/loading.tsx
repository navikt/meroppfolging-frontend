...
export default function Loading(): ReactElement {
  return (
    <VStack gap="space-24">
      ...
      <Skeleton>
        <BodyLong>
          Det er viktig at du tar stilling til din økonomiske situasjon i god
          tid før sykepengene tar slutt.
        </BodyLong>
      </Skeleton>
      <Skeleton>
        <BodyLong>
          Vi ber deg svare på to spørsmål, slik at vi best mulig kan gi deg
          informasjon som er relevant for deg. Du får også muligheten til å be
          om oppfølging fra en veileder.
        </BodyLong>
      </Skeleton>
      <Skeleton variant="rounded">
        <BeginFormButton />
