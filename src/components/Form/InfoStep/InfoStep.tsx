...
const getSituationInfo = (
  value: FremtidigSituasjonAnswerTypes,
): SituationInfo => {
  switch (value) {
    case "TILBAKE_HOS_ARBEIDSGIVER":
      return {
        content: <TilbakeHosArbeidsgiver />,
        heading: "Når du skal tilbake til arbeidsgiver",
      };
    case "TILBAKE_GRADERT":
      return {
        content: <TilbakeGradert />,
        heading: "Når du fortsatt er syk, men skal jobbe redusert",
      };
    case "BYTTE_JOBB":
    ...
    case "FORTSATT_SYK":
      return {
        content: <FortsattSyk />,
        heading: "Når du er for syk til å jobbe",
      };
    case "USIKKER":
